...
class ContentViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let storyB = UIStoryboard(name: "MainTab", bundle: nil)
        pageViewController = storyB.instantiateViewController(withIdentifier: "PageViewController") as? UIPageViewController
