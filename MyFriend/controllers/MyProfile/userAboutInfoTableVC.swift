...
class userAboutInfoTableVC: BaseTableViewController {
...
extension userAboutInfoTableVC: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate {
